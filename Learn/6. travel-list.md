...
export default function App() {
  // This state is needed inside PackingList.js (that is a sibling for Form.js), so it is lifted up from Form.js to App.js (that is the common parent component for Form.js and PackingList.js)
  ...
  return (
    <div className="app">
      <Logo />
      // Here we are passing a function to the component as a prop 
      <Form onAddItems={handleAddItems} /> 
      // Here the items is passed to packingList 
      <PackingList
        items={items}
...
export default function PackingList({
  ...
  // slice will take a copy from items array
