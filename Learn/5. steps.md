...
// Each React component, automatically receive children prop.
// The value of children prop is the string between opening (<Button>) and closing tag (</Button>) of the component.
